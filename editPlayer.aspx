<%@ Page Language="C#" AutoEventWireup="true" CodeFile="editPlayer.aspx.cs" Inherits="editPlayer" %>
...
<!--==============================Content=================================-->
			<form id="Form1" runat="server">
				<div class="container_12"><br /><br />
                    <div> <br /><h1 style="font-size:xx-large; margin-left:518px; font-weight:bold">Edit Player Information Here</h1></div>
                    <div>
                <br /><br /><br /><br />
                    ...
                    <tr style="  height: 39px;"><td class="auto-style1">
                        <asp:Label ID="Label1" runat="server" Text="Label">First Name</asp:Label></td><td>
                           <asp:DropDownList AutoPostBack="true" ID="first_name" style="  height: 23px;
  width: 201px;" runat="server" onselectedindexchanged="playerName_SelectedIndexChanged"></asp:DropDownList></tr>
                            <tr style="  height: 39px;"><td class="auto-style1">
  ...
  width: 201px;" runat="server"></asp:TextBox></td></tr>
            ...
            <br /><br />  <br /><br />
                <asp:Button ID="Button1" class="btn" style="  margin-left: 45%;" runat="server" Text="Click to Update Info" OnClick="button_click" />
                 <br /><br /> <br /><br /> <br /><br />
                </div>
            <br /><br /> 
