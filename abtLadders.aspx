<%@ Page Language="C#" AutoEventWireup="true" CodeFile="abtLadders.aspx.cs" Inherits="abtLadders" %>
<!DOCTYPE html>
...
<!--==============================Content=================================-->
			<div class="content">
				<div class="container_12"><br /><br /><br /><br />
                    <div> <br /><h1 style="font-size:xx-large; margin-left:456px; font-weight:bold">About Ladders</h1></div>
                   
                    <div style="font-size:larger;   font-size: larger;
  width: 85%;
  text-align: justify;
  margin-left: 91px;"><br /><br />
 Dear Hills Tennis Enthusiasts:<br /><br />
Spring is officially here, the nets are up and that means it is time to sign up for the 2014 Hills Tennis Challenge Ladders.<br /><br />
 
For the sixth consecutive year we are pleased to offer five separate ladders in 2014:<br /><br />
<b>Singles:</b>  Women’s, Men’s<br /><br />
<b>Doubles:</b>  Women’s, Men’s, Mixed<br /><br />
 
A tennis ladder is a great way to meet more tennis players, play more tennis and develop your game. Ladders are the gentlest path to get involved in competitive tennis. If you play tennis and keep score, you may wish to join one or more of the ladders. The ladders offer a flexible form of tennis competition. You play whenever, wherever, and with whom you wish. You determine how often you play. You may challenge other players on the ladder, and likewise you may be challenged by other members on the ladder.
<br /><br />
The 2014 ladder season will run from May through October. You may join the ladder and start playing matches at any time during this period.<br /><br />
			</div>
