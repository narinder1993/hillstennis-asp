<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ladders.aspx.cs" Inherits="ladders" %>
<!DOCTYPE html>
			...
			<div class="content">
				<div class="container_12"><br /><br /><br /><br />
					...
					<div class="option" style="margin-left: 50px ;width: 550px; ">
                       ...
                       <a href="teamRegister.aspx">  <img src="Images/ladder1.jpg" />
                           </a>
                    </div>
                    <div class="option" style="  width: 550px;  margin-top: -354px;  margin-left: 600px; ">
                       <a href="ladderRules.aspx"> <img src="Images/ladder2.jpg" /></a>

                    </div>
                    <div class="option" style="margin-left: 300px;width: 550px;">
                        <a href="abtLadders.aspx">
                            <img src="Images/ladder3.jpg" /></a>
                    </div>
					
                    </div>
                     <div style="  font-size: xx-large;  background-color: WHITE;  width: 550px;  margin-top: -50px;  position: absolute;  height: 55px;  margin-left: 300px;  opacity: 0.9;"> <a href="abtLadders.aspx"><h5 style="  margin-top: 19px;">   ABOUT LADDERS</h5></a></div>
                    <div style="  font-size: xx-large;  background-color: WHITE;  width: 550px;  margin-top: -420px;  position: absolute;  height: 55px;  margin-left: 600px;  opacity: 0.9;"><a href="ladderRules.aspx"> <h5 style="  margin-top: 19px;">   RULES</h5></a></div>
                    <div style="  font-size: xx-large;  background-color: WHITE;  width: 550px;  margin-top: -420px;  position: absolute;  height: 55px;  margin-left: 50px;  opacity: 0.9;"> <a href="schedule.aspx"><h5 style="  margin-top: 19px;">   LADDER RESULTS</h5></a></div>
                    </div>
			</div><br /><br />
		</div>
<!--==============================footer=================================-->
