<%@ Page Language="C#" AutoEventWireup="true" CodeFile="deletePlayer.aspx.cs" Inherits="deletePlayer" %>
<!DOCTYPE html>
<html lang="en">
	<head>
...
<!--==============================Content=================================-->
  ...
  width: 201px;" runat="server"></asp:TextBox></td></tr>
            ...
            <br /><br />  <br /><br />
                <asp:Button ID="Button1" class="btn" style="  margin-left: 45%;" runat="server" Text="Click to Delete" OnClick="button_click" />
                 <br /><br /> <br /><br /> <br /><br />
                </div>
            <br /><br /> 
