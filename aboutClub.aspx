<%@ Page Language="C#" AutoEventWireup="true" CodeFile="aboutClub.aspx.cs" Inherits="aboutClub" %>
...
<!--==============================Content=================================-->
				...
				<div class="container_12">
                    <p style="font-size:xx-large;  margin-left: 35%;">
                        <br /><br /><br /><br />
					<b>Welcome to Hills Community</b><br /><br /><br /><br />
                    <ul style="margin-left:5%; font-size:large; list-style-type:circle">
                       <p style="font-size:large"> This neighborhood tennis league has three goals:<br /><br /><br /><br /></p>
                        <li>To provide a fun, supportive environment for Hills residents tennis players of all abilities to enjoy tennis together;<br /></li><br />
                        <li>To introduce Hills tennis players to a broader group of players to expand their tennis network; and<br /></li><br />
                        <li>To build closer relations within The Hills community generally and within the tennis community in The Hills in particular.<br /></li><br />
                        </ul>
