...
<!--==============================Content=================================-->
			<form id="Form1" runat="server">
                ...
                <div><center>
                    <div> <br /><h1 style="font-size:xx-large; font-weight:bold">Enter Login Info</h1></div>
                <br /><br /><br />
                <table>
                    <tr style="  height: 39px;">
                        <td class="auto-style1">Enter the Username</td>
                        <td class="auto-style1">
                            <asp:TextBox ID="TextBox1" runat="server" Width="181px" Height="24px"></asp:TextBox>
                        </td>
                    
                    <tr style="  height: 39px;">
                            <td class="auto-style1">Enter the password</td>
                            <td class="auto-style1">
                                <asp:TextBox ID="TextBox2" runat="server" TextMode="Password" Width="181px" Height="24px"></asp:TextBox>
                            </td>
                    </tr>
            ...
            <br /><br />
                <asp:Button ID="Button1" class="btn" style="  " runat="server" Text="Click to Register" OnClick="button_click" />
                    </center>
                </div>
            <br /><br />
