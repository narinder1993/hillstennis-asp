<%@ Page Language="C#" AutoEventWireup="true" CodeFile="aboutUsMain.aspx.cs" Inherits="aboutUsMain" %>
<!DOCTYPE html>
...
<!--==============================Content=================================-->
			<div class="content">
				<div class="container_12"><br /><br /><br /><br />
                    <div>
					<div class="option" style="margin-left: 50px ;width: 550px; ">
                        
                       <a href="aboutClub.aspx">  <img src="Images/aboutHCTA.jpg" />
                           </a>
                    </div>
                    <div class="option" style="  width: 550px;  margin-top: -340px;  margin-left: 600px; ">
                       <a href="contactUs.aspx"> <img src="Images/contact-us.jpg" /></a>

                    </div>
                    <div class="option" style="margin-left: 300px;width: 550px;">
                        <a href="directions.aspx">
                            <img src="Images/750px-RamseyNJ.jpg" /></a>
                    </div>
					
                    </div>
                     <div style="  font-size: xx-large;  background-color: WHITE;  width: 550px;  margin-top: -50px;  position: absolute;  height: 55px;  margin-left: 300px;  opacity: 0.9;"> <a href="directions.aspx"><h5 style="  margin-top: 19px;"> DIRECTIONS TO COURTS  </h5></a></div>
                    <div style="  font-size: xx-large;  background-color: WHITE;  width: 550px;  margin-top: -387px;  position: absolute;  height: 55px;  margin-left: 600px;  opacity: 0.9;"><a href="contactUs.aspx"> <h5 style="  margin-top: 19px;">   CONTACT US</h5></a></div>
                    <div style="  font-size: xx-large;  background-color: WHITE;  width: 550px;  margin-top: -387px;  position: absolute;  height: 55px;  margin-left: 50px;  opacity: 0.9;"> <a href="aboutClub.aspx"><h5 style="  margin-top: 19px;">  HCTA BOARD </h5></a></div>
                    </div>
			</div><br /><br />
		</div>
<!--==============================footer=================================-->
