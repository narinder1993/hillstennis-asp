<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowTeams.aspx.cs" Inherits="ShowTeams" %>
...
<!--==============================Content=================================-->
			<form id="Form1" runat="server">
				<div class="container_12"><br /><br />
                    <div> <br /><h1 style="font-size:xx-large; margin-left:480px; font-weight:bold">All Teams Information Here</h1></div>
                    <br /><br />
                    <div style="text-align:center; margin-left:50px">
                    <asp:GridView ID="GridView1" style="  margin-left: -71px;" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource1" GridLines="Horizontal" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" Width="1218px">
                        <Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [teamInfo] ORDER BY [teamNo]"></asp:SqlDataSource>
            <br /><br /> 
