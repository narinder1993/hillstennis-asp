<%@ Page Language="C#" AutoEventWireup="true" CodeFile="socialEvents.aspx.cs" Inherits="socialEvents" %>
...
<!--==============================Content=================================-->
			<div class="content">
				<div class="container_12"><br /><br />
                    <div>
                        <div> <br /><h1 style="font-size:xx-large;  font-weight:bold"><center>SOCIAL EVENTS </center></h1></div><br /><br />
					<div class="option" style="margin-left: 50px ;width: 550px; ">
                        
                       <a href="teamRegister.aspx"> <img src="Images/calendar.jpg" /> 
                           </a>
                    </div>
                    <div class="option" style="  width: 550px;  margin-top: -364px;  margin-left: 600px; ">
                       <a href="ladderRules.aspx"> <img src="Images/gallery.jpg" /></a>

                    </div>
                    
					
                    </div>
                    <div style="  font-size: xx-large;  background-color: WHITE;  width: 550px;  margin-top: -53px;  position: absolute;  height: 55px;  margin-left: 600px;  opacity: 0.9;"><a href="ladderRules.aspx"> <h5 style="  margin-top: 19px;">  GALLERY</h5></a></div>
                    <div style="  font-size: xx-large;  background-color: WHITE;  width: 550px;  margin-top: -53px;  position: absolute;  height: 55px;  margin-left: 50px;  opacity: 0.9;"> <a href="schedule.aspx"><h5 style="  margin-top: 19px;">   CALENDER</h5></a></div>
                    </div>
			</div><br /><br />
		</div>
<!--==============================footer=================================-->
