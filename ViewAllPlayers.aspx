<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewAllPlayers.aspx.cs" Inherits="ViewAllPlayers" %>
<!DOCTYPE html>
<html lang="en">
	<head>
						...
						<div class="menu_block">
							<nav class="horizontal-nav full-width horizontalNav-notprocessed">
								<ul class="sf-menu">
									...
									<li class="current"><a href="#">Members</a>
...
<!--==============================Content=================================-->
			<form id="Form1" runat="server">
				<div class="container_12"><br /><br />
                    <div> <br /><h1 style="font-size:xx-large; margin-left:518px; font-weight:bold">All Player Information Here</h1></div>
                    <br /><br />
                    <div style="text-align:center">
                    <asp:GridView ID="GridView1" style="  margin-left: -71px;" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="Id" DataSourceID="SqlDataSource1" GridLines="Horizontal" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" Width="1333px">
                        <Columns>
                            ...
                            <asp:BoundField DataField="ratingOrg" HeaderText="Rating Organization" SortExpression="ratingOrg" />
                        </Columns>
